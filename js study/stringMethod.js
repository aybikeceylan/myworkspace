...
//         console.log(`${str1} ve ${str2} birbirine eşittir`) :
//         console.log(`${str1} ve ${str2} birbirine eşittir değildir`);
// }
...
//         (`${str1} ve ${str2} birbirine eşittir`) :
//         (`${str1} ve ${str2} birbirine eşittir değildir`);
// }
